...
const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg p-3 w-full h-[500px] overflow-hidden">
      <article className="flex flex-col p-4 bg-white rounded-xl border border-gray-200 h-full font-fontsm">
        ...
        <div className="relative w-full h-[250px] mb-4 group">
          <div className="relative overflow-hidden h-full">
            <div className="flex transition-transform duration-300 h-full">
              {valuesArray.map((image, index) => (
                <div
                  key={index}
                  className="flex-none w-full h-full rounded-lg bg-gray-200"
                >
                  <img
                    src={image}
        ...
        <div className="flex justify-between mt-4 pt-4 border-t border-neutral-300">
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-start text-fontlit pl-1.5">
