  ...
  const [cards] = useState<Card[]>([
    {
      ...
      title: "Post Updates",
      description:
        "Share medical insights, case studies, and industry advancements to keep your peers informed and engaged.",
      button: "Share post",
      imgage: sharepost,
    },
    {
      ...
      title: "Ask Questions",
      description:
        "Seek expert advice, discuss complex cases, and gain valuable perspectives from the medical community",
    ...
    },
    {
      ...
      description:
        "Post quick medical tips, procedural guides, and research highlights in an easy-to-consume format.",
      button: " Share video",
      imgage: sharevideo,
    },
    {
      id: 4,
      title: "Access & Share Resources",
      description:
        "Upload and explore medical notes, research papers, clinical guidelines, and essential industry updates.",
      button: " Share job",
      imgage: shareresource,
    },
    {
      id: 5,
      title: "Discover Career Opportunities",
      description:
        "Find job openings, internships, and fellowships tailored for healthcare professionals.",
      button: " Share resource",
      imgage: sharejobs,
    },
    {
      id: 6,
      title: "Connect with Experts & Peers",
      description:
        "Build meaningful connections with specialists, researchers, and like-minded professionals.",
      button: "Connect ",
      imgage: connectwith,
    },
  ]);
      ...
      >
        <div
          ...
          style={{
            ...
            transition: isTransitioning ? "none" : "transform 1000ms ease-out",
          }}
        ...
        >
          {visibleCards.map((card, index) => (
            <div
              key={`${card.id}-${index}`}
              className="relative w-full h-[150px] flex-shrink-0 font-fontsm"
            >
              <div className="absolute border-2 border-gray-100 bg-white p-3 rounded-xl   w-full h-[155px ] flex  items-center">
                ...
                <div className="flex flex-col items-start pl-2 mt-2 ">
                  ...
                  <p className="text-gray-500 text-fontlit">
                    {card.description}
                  </p>
                  <button className="px-3 py-1 mt-2 text-fontlit text-white bg-maincl rounded-xl">
                    {card.button}
                  </button>
                </div>
              </div>
